...
<p align="center">
  <img src="./assets/screenshot.png" alt="AI Assistant Demo Screen" width="600">
</p>
...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/YOUR_USERNAME/ai-doc-assistant.git](https://github.com/Davidva0812/personal-rag-ai-assistant.git)
